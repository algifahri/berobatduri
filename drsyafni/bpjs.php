 <div class="wrapper wrapper--w790">
    <div class="card card-5">
        ...
        <div class="card-body">
            <form method="POST" action="berobat_bpjs.php">
                <div class="form-row">
                ...
                <div class="form-row">
                    ...
                    <div class="value">
                        <div class="input-group">
                            <input class="input--style-5" type="number" name="nomor_hp" required/>
                        </div>
                    </div>
                </div>
                <div class="form-row">
                ...
                <div class="form-row">
                    <div class="name">Nomor BPJS</div>
                    <div class="value">
                        <div class="input-group">
                            <input class="input--style-5" type="text" name="nomor_bpjs" required>
                        </div>
                    </div>
                </div>

                <div>
                    <button class="btn btn--radius-2 btn--red" type="submit">Daftar Pasien BPJS</button>
                </div>
            </form>
        </div>
    </div>
